...
- [ ] Generics React-specific foram revisados na referência `react-typescript/generic-components.md`?
...
- [ ] Regras específicas de React não foram duplicadas em `references/typescript/`?
- [ ] Props, children, events, refs, hooks e componentes genéricos usam `references/react-typescript/`?
